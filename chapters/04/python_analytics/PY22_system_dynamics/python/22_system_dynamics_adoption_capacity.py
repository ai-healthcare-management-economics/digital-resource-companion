"""Self-contained runner: System-dynamics model of adoption, capacity, and value.
...
from aihe_analytics.module_22_system_dynamics_adoption_capacity import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "22_system_dynamics_adoption_capacity_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='System-dynamics model of adoption, capacity, and value')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: System-dynamics model of adoption, capacity, and value")
