"""Self-contained runner: Agent-based simulation of clinician adoption.
...
def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "23_agent_based_clinician_adoption_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Agent-based simulation of clinician adoption')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Agent-based simulation of clinician adoption")
