"""Self-contained runner: Workflow time, capacity, productivity, and benefit realization.
...
from aihe_analytics.module_28_workflow_productivity import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "28_workflow_productivity_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Workflow time, capacity, productivity, and benefit realization')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Workflow time, capacity, productivity, and benefit realization")
