...
from aihe_analytics.module_10_tcaio_lifecycle_costing import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "10_tcaio_lifecycle_costing_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Total Cost of AI Ownership (TCAIO) lifecycle costing')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Total Cost of AI Ownership (TCAIO) lifecycle costing")
