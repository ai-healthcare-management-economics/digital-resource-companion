...
Open `notebook/09_temporal_validation_and_drift.ipynb` from this module in JupyterLab, VS Code, or Google Colab. Retain the complete module folder so that the notebook, input data, environment files, and `src/` implementation remain together.
...
[Repository notebook](https://github.com/ai-healthcare-management-economics/digital-resource-companion/blob/main/chapters/12/python_analytics/PY09_drift/notebook/09_temporal_validation_and_drift.ipynb) · [Open in Google Colab](https://colab.research.google.com/github/ai-healthcare-management-economics/digital-resource-companion/blob/main/chapters/12/python_analytics/PY09_drift/notebook/09_temporal_validation_and_drift.ipynb)
