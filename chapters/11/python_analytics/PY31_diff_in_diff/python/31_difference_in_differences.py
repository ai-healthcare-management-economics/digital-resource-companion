"""Self-contained runner: Difference-in-differences evaluation.
...
from aihe_analytics.module_31_difference_in_differences import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "31_difference_in_differences_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Difference-in-differences evaluation')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Difference-in-differences evaluation")
