...
from aihe_analytics.module_05_performance_and_calibration import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "05_performance_and_calibration_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Model performance, threshold trade-offs, and calibration')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Model performance, threshold trade-offs, and calibration")
