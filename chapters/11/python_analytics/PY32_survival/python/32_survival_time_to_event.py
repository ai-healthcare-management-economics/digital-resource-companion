...
from aihe_analytics.module_32_survival_time_to_event import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "32_survival_time_to_event_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Time-to-event and survival analysis')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Time-to-event and survival analysis")
