"""Self-contained runner: Random-effects meta-analysis and forest plot.
...
from aihe_analytics.module_30_random_effects_meta_analysis import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "30_random_effects_meta_analysis_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Random-effects meta-analysis and forest plot')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Random-effects meta-analysis and forest plot")
