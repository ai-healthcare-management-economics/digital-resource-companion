...
from aihe_analytics.module_04_predictive_model_comparison import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "04_predictive_model_comparison_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Predictive model development: logistic regression and random forest')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Predictive model development: logistic regression and random forest")
