"""Self-contained runner: Descriptive statistics and visual comparisons.
...
from aihe_analytics.module_02_descriptive_statistics_and_visuals import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "02_descriptive_statistics_and_visuals_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Descriptive statistics and visual comparisons')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Descriptive statistics and visual comparisons")
