"""Self-contained runner: Probabilistic sensitivity analysis, CEAC, and EVPI.
...
from aihe_analytics.module_15_probabilistic_sensitivity_ceac_evpi import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "15_probabilistic_sensitivity_ceac_evpi_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Probabilistic sensitivity analysis, CEAC, and EVPI')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Probabilistic sensitivity analysis, CEAC, and EVPI")
