"""Self-contained runner: Decision-tree pathway model.
...
from aihe_analytics.module_18_decision_tree_pathway import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "18_decision_tree_pathway_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Decision-tree pathway model')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Decision-tree pathway model")
