...
Open `notebook/18_decision_tree_pathway.ipynb` from this module in JupyterLab, VS Code, or Google Colab. Retain the complete module folder so that the notebook, input data, environment files, and `src/` implementation remain together.
...
[Repository notebook](https://github.com/ai-healthcare-management-economics/digital-resource-companion/blob/main/chapters/08/python_analytics/PY18_decision_tree/notebook/18_decision_tree_pathway.ipynb) · [Open in Google Colab](https://colab.research.google.com/github/ai-healthcare-management-economics/digital-resource-companion/blob/main/chapters/08/python_analytics/PY18_decision_tree/notebook/18_decision_tree_pathway.ipynb)
