...
Open `notebook/14_deterministic_sensitivity_tornado.ipynb` from this module in JupyterLab, VS Code, or Google Colab. Retain the complete module folder so that the notebook, input data, environment files, and `src/` implementation remain together.
...
[Repository notebook](https://github.com/ai-healthcare-management-economics/digital-resource-companion/blob/main/chapters/08/python_analytics/PY14_sensitivity/notebook/14_deterministic_sensitivity_tornado.ipynb) · [Open in Google Colab](https://colab.research.google.com/github/ai-healthcare-management-economics/digital-resource-companion/blob/main/chapters/08/python_analytics/PY14_sensitivity/notebook/14_deterministic_sensitivity_tornado.ipynb)
