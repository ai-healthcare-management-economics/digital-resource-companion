"""Self-contained runner: Deterministic sensitivity and tornado analysis.
...
from aihe_analytics.module_14_deterministic_sensitivity_tornado import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "14_deterministic_sensitivity_tornado_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Deterministic sensitivity and tornado analysis')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Deterministic sensitivity and tornado analysis")
