"""Self-contained runner: Patient-level microsimulation.
...
from aihe_analytics.module_20_patient_microsimulation import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "20_patient_microsimulation_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Patient-level microsimulation')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Patient-level microsimulation")
