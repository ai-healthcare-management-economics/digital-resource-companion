...
from aihe_analytics.module_21_discrete_event_hospital_flow import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "21_discrete_event_hospital_flow_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Discrete-event simulation of hospital flow')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Discrete-event simulation of hospital flow")
