"""Self-contained runner: Constrained resource-allocation optimization.
...
from aihe_analytics.module_35_resource_allocation_optimization import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "35_resource_allocation_optimization_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Constrained resource-allocation optimization')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Constrained resource-allocation optimization")
