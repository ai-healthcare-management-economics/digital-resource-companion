"""Self-contained runner: Time-series forecasting for demand, capacity, and budget planning.
...
from aihe_analytics.module_34_time_series_forecasting import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "34_time_series_forecasting_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Time-series forecasting for demand, capacity, and budget planning')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Time-series forecasting for demand, capacity, and budget planning")
