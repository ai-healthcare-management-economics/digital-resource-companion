"""Self-contained runner: Weighted procurement scorecard with mandatory safeguards.
...
from aihe_analytics.module_25_procurement_mcda_scorecard import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "25_procurement_mcda_scorecard_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Weighted procurement scorecard with mandatory safeguards')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Weighted procurement scorecard with mandatory safeguards")
