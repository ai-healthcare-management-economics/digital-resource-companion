...
from aihe_analytics.module_08_subgroup_equity_audit import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "08_subgroup_equity_audit_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Subgroup performance and equity audit')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Subgroup performance and equity audit")
