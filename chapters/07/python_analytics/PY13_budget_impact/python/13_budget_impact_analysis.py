"""Self-contained runner: Multiyear budget-impact analysis.
...
from aihe_analytics.module_13_budget_impact_analysis import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "13_budget_impact_analysis_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Multiyear budget-impact analysis')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Multiyear budget-impact analysis")
