"""Self-contained runner: Cost-effectiveness, ICER, and net monetary benefit.
...
from aihe_analytics.module_12_cost_effectiveness_icer_nmb import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "12_cost_effectiveness_icer_nmb_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Cost-effectiveness, ICER, and net monetary benefit')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Cost-effectiveness, ICER, and net monetary benefit")
