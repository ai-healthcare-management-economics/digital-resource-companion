...
from aihe_analytics.module_16_distributional_cost_effectiveness import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "16_distributional_cost_effectiveness_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Distributional cost-effectiveness and equity-weighted analysis')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Distributional cost-effectiveness and equity-weighted analysis")
