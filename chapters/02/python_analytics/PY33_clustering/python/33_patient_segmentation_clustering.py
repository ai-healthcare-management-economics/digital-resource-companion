"""Self-contained runner: Patient or service segmentation using clustering.
...
from aihe_analytics.module_33_patient_segmentation_clustering import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "33_patient_segmentation_clustering_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Patient or service segmentation using clustering')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Patient or service segmentation using clustering")
