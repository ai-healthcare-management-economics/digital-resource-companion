"""Self-contained runner: Data quality, fitness-for-purpose, and mapping audit.
...
from aihe_analytics.module_01_data_quality_and_mapping import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "01_data_quality_and_mapping_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Data quality, fitness-for-purpose, and mapping audit')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Data quality, fitness-for-purpose, and mapping audit")
