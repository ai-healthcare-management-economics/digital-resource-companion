"""Self-contained runner: Missing-data sensitivity analysis.
...
from aihe_analytics.module_03_missing_data_sensitivity import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "03_missing_data_sensitivity_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Missing-data sensitivity analysis')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Missing-data sensitivity analysis")
