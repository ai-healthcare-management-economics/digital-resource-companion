...
Detailed annual and category cost tables, present-value summary, cost-per-use estimates, scn comparison, category chart, annual-cost chart, and summary JSON.
